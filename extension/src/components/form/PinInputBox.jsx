...
export default function PinInputBox({value, onChange, mask, autoFocus, onKeyDown, required}) {
    ...
    return (
        ...
        >
            ...
            <HStack py={theme.paddingS} color={theme.text} fontSize={theme.textSize}>
                <PinInput type="number" value={value} onChange={onChange} mask={mask} autoFocus={autoFocus} required={required} variant='unstyled' size='xs'>
                    <PinInputField />
                    <PinInputField />
                    <PinInputField />
                    <PinInputField />
